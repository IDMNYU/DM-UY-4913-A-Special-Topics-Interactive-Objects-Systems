...
In this course, students will learn how to create interactive objects and systems by building them with physical computing. Physical computing is a means to create interactive systems that translate human expressions from the surrounding world to the digital world, using both software and hardware. Physical Computing is one approach to human-computer interaction design. Taking the human body as a given, students will learn how a computer converts the changes in energy given off by our bodies – sound, light, heat, motion, etc. – into changing electronic signals that computers can read and interpret. Students will learn to build and program their own micro-controller board, with an emphasis on techniques and approaches for the generation of temporal and spatial processes. Through discussions of design interfaces and interactivity, students will design computing applications that utilize these forms of physical expression. Possibilities include the control of kinetic sculptures, custom performance interfaces, installations, the presence of sound or light and reactive/interactive/responsive works.

Students will be building circuits, writing code, soldering, creating systems that track and control input and output which generates some form of expression.

### Course Pre-requisites

This course utilizes programming, electronics and coupling them together to create interactive systems.

It is helpful to have some basic knowledge of programming (Java, C++, Processing, JavaScript, C#, etc). If you do not have that, I suggest studying the handouts in the reference section, which cover introductory concepts for programming. If you are unsure, review the documents to refresh your memory, if nothing else. Programming will be utilized within and throughout the course. Programming Topics will be covered in lecture. 

This is an introductory course in circuits and electronics. No prior experience is necessary.
...
•	To gain an articulate an awareness and sensitivity of interactive systems, including the difference between reactive, interactive and responsive systems as well as input and output

•	To design engaging interactive systems, which encourage interaction and exploration

•	To design systems which liberate the computer from traditional definitions and to exist within the physical world around us.

•	Competent circuit construction

•	Further development/utilization of programming skills

•	Completion of several exercises and a final project for group critiques


## Course Structure

This is a hybrid course - both online and in the physical classroom. Video lectures and readings must to be completed BEFORE class time. Class time will be an active lab with challenges, workshops, class discussions, critiques and making. 

The structure of the semester will be the following:

Part I: Basic circuits, basic programming, input and output

Part II: Devices, Networking and reliable interaction
...
Grades will be attributed to work based on your understanding and comprehension of the course materials & principles (both from the texts and lectures), creativity and craft. (Craft refers to the care you've taken to create the work. Is it thought out, considered, and sound? Or is it thrown together and hapazard?) All of these will be evident in your projects and participation throughout class


##### A. Excellent (90-100: Work of exceptional quality; Exceeds Expectations)
Performance, participation, and attendance of the student has been of the highest level, showing sustained excellence in meeting course responsibilities. Work clearly differentiates itself from other work, has memorable impact, pursues concepts and techniques above and beyond what is discussed in class. The student thoroughly understands the theory and practice behind physical computing.

##### B. Very Good / Good (80-89: Work of high quality)
Performance, participation, and attendance of the student has been good, though not of the highest level. Work demonstrates a better than average understanding of physical computing.

##### C. Satisfactory (70-79: Average; Satisfies course requirements)
Performance and attendance of the student has been adequate, satisfactorily meeting the course requirements. Work is average and competent, showing a basic understanding of physical computing.

##### D. Poor; Below Average (60-69: Deficient, but passing)
Performance and attendance of the student has been less than adequate. Work is lacking in many or most areas that show any understanding of physical computing. Problems may include lack of interest, procrastination, poor planning and poor craft.
...
Assignments that are not submitted will receive a "0". Please realize that a "0" mark is a fantastic way to tank your grade. Getting an F (63%) is far better than getting a zero (0%). Do the math.

### Assessment
Assessment will occur by reviewing weekly assignments & challenges, project milestones, and final projects. The course is cumulative.  Please see the Grading Section for specific grade breakdown, calendar for due dates, and assignments for briefs. Grades will be individually distributed via Slack Direct Message. Feedback occurs during class critique as well as on Slack. Do review those comments as feedback for future projects and tips.
...
Students will evaluate their own progressed in a course in three ways: 1) A course evaluation form, which will be developed based on the course’s individual objectives. 2) Students will participate in a self reflection assignment due Week 7  & Week 15   or as otherwise noted. This written evaluation is an important componet to assessing your Engagement and Participation Grade. It will be turned into me as a separate document. 3.) Turning in Tickets to Leave when requested, which will be almost weekly.

• Critically analyze/evaluate how much time was spent learning programming concepts & electronics concepts vs. actually programming, building and making. How does this reflect on the final quality of your end result? 
...
* Devote at a minimum 8 to 10 hours per week outside of class, fulfilling homework assignments, reading, and studying concepts covered in class.
* Demonstrate Curiosity
* Take risks, push yourself and be fearless in your projects
* Consult slack at least twice a week for up to date info
...
### Important Aspects to this Course

• **Time** Time management is everything. You will need it to have reasonable accomplishments in this class. The material is cumulative. The readings and videos are essential. Writing code and constructing circuits are the only way to make progress and to fully synthesize the material. It becomes evident quite quickly, if you are not doing this and you will fall behind. Develop excellent time management. You will need 8-10 hours outside of class to succeed. 
...
Do the follow these steps to setup each assignment on Github:
	...
	* 0. Save your work AND all of the necessary support files (index.html, libraries folder, pictures, media, etc) in a folder that is titled in this manner on your computer:
					*YourFirstNameYourLastName_AssignmentNumber*, etc.
...
## [E.2: DIY Custom Switch](DIY_Switch.md)

## [E.3: Fantasy Device](Fantasy_Device.md)

## [E.4: Cute & Unexpected Tricks](Cute_Unexpected_Tricks.md)

## [E.5:Motor Control](Motor_Control.md)

## [E.6: Fortune Telling](Fortune_Telling.md)

## [E.7: Final Project Roundtable](Final_Project_Roundtable.md)
